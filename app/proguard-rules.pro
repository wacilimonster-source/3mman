...
## 保持自定义实体类不被混淆
-keep class com.m3man.data.model.** { *; }
-keep class com.m3man.data.db.** { *; }
## greenDao ##
...
-keepclassmembers class com.u91mman.data.model.HostJsScope$RetJavaObj{ *; }
-keepclassmembers class com.u91mman.data.model.HostJsScope{ *; }
