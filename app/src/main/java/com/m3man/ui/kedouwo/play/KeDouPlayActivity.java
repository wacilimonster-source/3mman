...
import com.m3man.R;
import com.m3man.adapter.KeDouAdapter;
...
public class KeDouPlayActivity extends MvpActivity<KeDouPlayView, KeDouPlayPresenter> implements KeDouPlayView, OnPreparedListener {
    ...
    private void setupFullScreenPlayer() {
        ...
        ViewGroup.LayoutParams containerParams = mFrContainer.getLayoutParams();
        containerParams.height = screenHeight;
        mFrContainer.setLayoutParams(containerParams);
